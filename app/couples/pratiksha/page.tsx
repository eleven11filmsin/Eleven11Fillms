                    ...
                    {waveBars.map((h, i) => (
                        <span
                            ...
                            style={{
                                height: `${h}px`,
                                animation: playing
                                    ? `waveBar 1.2s ease-in-out ${i * 0.15}s infinite`
                                    : "none",
                            }}
                        />
                    ))}
...
export default function Pratiksha() {
    ...
    return (
        <main className="min-h-screen bg-[#f0ebe3] flex flex-col overflow-x-hidden">
            ...
            <div className="flex flex-col items-center pt-12 sm:pt-16 md:pt-20 pb-10 gap-5 sm:gap-6 px-4">
                ...
                <div className="flex flex-col sm:flex-row items-center sm:gap-4 gap-1 bg-gray-200/60 px-4 sm:px-6 py-3 sm:py-4 w-full max-w-2xl text-center sm:text-left">
                    <span className="text-gray-500 text-xs sm:text-sm italic break-words">
                ...
                {galleryItems.map((item, i) => {
                    ...
                    return (
                        <div
                            ...
                            className={`relative w-full mx-auto transition-all duration-700 ${visible[i]
