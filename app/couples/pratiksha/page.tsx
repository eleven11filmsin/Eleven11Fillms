...
const galleryItems: GalleryItem[] = [
    { kind: "single", src: "/images/pratiksha/1.PNG", w: 360, h: 440 },
    ...
    { kind: "single", src: "/images/pratiksha/8.jpg", w: 340, h: 420 },
    { kind: "single", src: "/images/pratiksha/9.jpg", w: 360, h: 440 },
    { kind: "single", src: "/images/pratiksha/10.jpg", w: 340, h: 420 },
    { kind: "single", src: "/images/pratiksha/11.jpg", w: 360, h: 440 },
    { kind: "single", src: "/images/pratiksha/12.jpg", w: 340, h: 420 },
];
...
export default function Pratiksha() {
    ...
    return (
        <main className="min-h-screen bg-[#f0ebe3] flex flex-col overflow-x-hidden">
            ...
            <CoupleAudioPlayer
                audioSrc="/audio/pratikshagallery.mp3"
                title="pratiksha"
                coupleName="Pratiksha"
            />
