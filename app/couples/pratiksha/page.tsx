...
const galleryItems: GalleryItem[] = [
  { kind: "single", src: "/images/pratiksha/DSC07610.jpg", w: 360, h: 440 },
  { kind: "collage", src: "/images/pratiksha/DSC07595.jpg", w: 360, h: 420 },
  { kind: "single", src: "/images/pratiksha/IMG_6166.jpg", w: 340, h: 420 },

  { kind: "collage", src: "/images/pratiksha/DSC07837 2.jpg", w: 360, h: 300 },
  { kind: "single", src: "/images/pratiksha/DSC08087.jpg", w: 320, h: 400 },
  { kind: "single", src: "/images/pratiksha/DSC07851 2.jpg", w: 350, h: 430 },
  { kind: "single", src: "/images/pratiksha/DSC08293.jpg", w: 300, h: 380 },

  { kind: "single", src: "/images/pratiksha/DSC07963.jpg", w: 340, h: 420 },
  { kind: "single", src: "/images/pratiksha/DSC08190.jpg", w: 340, h: 420 },
  { kind: "single", src: "/images/pratiksha/DSC08087.jpg", w: 350, h: 440 },
  { kind: "single", src: "/images/pratiksha/DSC08206.jpg", w: 350, h: 440 },
  { kind: "single", src: "/images/pratiksha/DSC08231.jpg", w: 330, h: 410 },
  { kind: "single", src: "/images/pratiksha/DSC08235.jpg", w: 340, h: 420 },
];
...
export default function RevaAndZach() {
  ...
  return (
    <main className="min-h-screen bg-[#f0ebe3] flex flex-col">
      ...
      <nav className="w-full flex items-center justify-between px-20 py-6 border-b border-gray-200">
        ...
        <div className="flex items-center gap-10">
          <a href="https://www.instagram.com/eleven11films/" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
            <Image src="/images/pratiksha/instagram.jpg" alt="Instagram" width={24} height={24} />
          </a>
          <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
            <Image src="/images/pratiksha/youtube.jpg" alt="YouTube" width={24} height={24} />
          </a>
          <a href="https://www.facebook.com/profile.php?id=61567440545491" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
            <Image src="/images/pratiksha/facebook.jpg" alt="Facebook" width={24} height={24} />
          </a>
          <a href="https://vimeo.com/eleven11films?fl=pp&fe=sh" target="_blank" rel="noopener noreferrer" className="hover:opacity-70 transition-opacity">
            <Image src="/images/pratiksha/vimeo.jpg" alt="Vimeo" width={24} height={24} />
          </a>
          <Link
            href="/contact"
      ...
      <div className="flex flex-col items-center pt-20 pb-10 gap-6">
        ...
        <div className="flex items-center gap-4 bg-gray-200/60 px-6 py-4 w-full max-w-2xl">
          <span className="text-gray-500 text-sm italic">
            Où tu ne m&apos;attendais pas (feat. Christophe)
          </span>
          <span className="text-gray-400 text-xs">— Isabelle Adjani</span>
        </div>
      </div>
