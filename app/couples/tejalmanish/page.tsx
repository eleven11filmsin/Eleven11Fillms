...
const galleryItems: GalleryItem[] = [
    { kind: "single", src: "/images/tejalmanish/1.jpg", w: 360, h: 440 },
    { kind: "collage", src: "/images/tejalmanish/2.jpg", w: 340, h: 420 },
    { kind: "single", src: "/images/tejalmanish/3.jpg", w: 360, h: 440 },

    { kind: "collage", src: "/images/tejalmanish/4.jpg", w: 420, h: 300 },
    { kind: "single", src: "/images/tejalmanish/5.jpg", w: 420, h: 300 },
    { kind: "single", src: "/images/tejalmanish/6.jpg", w: 350, h: 430 },
    { kind: "single", src: "/images/tejalmanish/7.jpg", w: 420, h: 300 },

    { kind: "single", src: "/images/tejalmanish/8.jpg", w: 340, h: 420 },
    { kind: "single", src: "/images/tejalmanish/9.jpg", w: 420, h: 300 },
    { kind: "single", src: "/images/tejalmanish/10.jpg", w: 360, h: 440 },
    { kind: "single", src: "/images/tejalmanish/11.jpg", w: 420, h: 300 },
    { kind: "single", src: "/images/tejalmanish/12.jpg", w: 420, h: 300 },
];
...
export default function tejalmanish() {
    ...
    return (
        <main className="min-h-screen bg-[#f0ebe3] flex flex-col overflow-x-hidden">
            ...
            {/* ===== DESKTOP NAVBAR (md+) ===== */}
            <nav className="hidden md:flex items-center justify-between gap-8 px-6 md:px-8 lg:px-12 xl:px-16 py-4 ">
            ...
            <CoupleAudioPlayer
                audioSrc="/audio/tejalmanishgallery.mp3"
                title="Tejal & Manish"
                coupleName="Tejal & Manish"
            />
            <Footer />
        </main >
    );
